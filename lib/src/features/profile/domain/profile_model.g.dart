...
void _profileSerialize(
  ...
  writer.writeStringList(offsets[1], object.radarLabels);
  writer.writeLongList(offsets[2], object.radarValues);
...
Profile _profileDeserialize(
  ...
  object.radarLabels = reader.readStringList(offsets[1]) ?? [];
  object.radarValues = reader.readLongList(offsets[2]) ?? [];
